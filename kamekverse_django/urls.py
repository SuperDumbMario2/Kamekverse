...
urlpatterns = [
    ...
    path('titles/<int:olive_title_id>/<int:olive_community_id>/edit/icon', views.community_editor_icon),
    path('titles/<int:olive_title_id>/<int:olive_community_id>/edit/whitelist', views.community_editor_whitelist),
    ...
    path('settings/api/keys', views.settings_api_keys),
    path('settings/api/new', views.settings_api_new),
    path('settings/api/toggle_activation/<int:id>', views.settings_api_toggle_activate),
    path('settings/api/regenerate/<int:id>', views.settings_api_regenerate),
